              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center space-x-4 pt-4">
                    {project.category === 'devops' && project.githubLink && (
                      <a
                    ...
                    {project.websiteLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`flex items-center justify-center space-x-2 font-mono font-semibold transition-all duration-200 ${
                          project.category === 'fullstack'
                            ? 'w-full px-6 py-3 bg-primary-500 text-bg-surface hover:bg-primary-700 rounded-lg shadow-glow hover:shadow-card-hover'
                            : 'text-neutral-400 hover:text-primary-500 group/btn'
                        }`}
                      >
                        <ExternalLink size={project.category === 'fullstack' ? 18 : 16} className={project.category === 'fullstack' ? '' : 'group-hover/btn:scale-110 transition-transform'} />
                        <span className={project.category === 'fullstack' ? 'text-base' : 'text-sm'}>
                          {project.category === 'fullstack' ? 'Visit Live Site' : 'Live'}
                        </span>
                      </a>
                    )}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://github.com/Akum65358Blaise"
                target="_blank"
                rel="noopener noreferrer"
