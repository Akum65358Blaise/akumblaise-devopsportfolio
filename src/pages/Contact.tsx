...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // To get your Web3Forms access key: https://web3forms.com
      const accessKey = import.meta.env.VITE_WEB3FORMS_ACCESS_KEY || "365d3bf2-3eff-4844-a5cc-ab67429f27d2";
      ...
      setErrors(prev => ({ 
        ...prev, 
        message: error instanceof Error ? error.message : "Failed to send message. Please try again or email me directly at akumacha@gmail.com" 
      }));
    } finally {
