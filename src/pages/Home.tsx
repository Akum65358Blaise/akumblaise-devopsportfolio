        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="font-mono text-4xl md:text-6xl lg:text-8xl font-bold tracking-tight text-primary-500">
              <Typewriter text="Senior DevOps & Platform Engineer" delay={80} />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="font-mono text-3xl md:text-4xl font-bold text-primary-500 mb-6">
              Ready to Fix Your Platform Problems?
            </h2>
            <p className="text-xl text-neutral-200 mb-8 leading-relaxed">
              If you're building or scaling a platform team, or need someone who thinks in systems, not just scripts—let's talk. 
              Whether it's deployment speed, cloud costs, uptime, or developer experience—I engineer outcomes that compound.
            </p>
