        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="font-mono text-sm text-neutral-400 text-center">
            ...
            <div className="mt-2 space-y-1 text-xs">
              <p>© {currentYear} Akum Blaise Acha - Senior DevOps & Platform Engineer</p>
              <p>Built with React, TypeScript, and Cyber Terminal Aesthetic</p>
              <p className="text-primary-500">Status: Open to Senior DevOps Engineer, Platform Engineer, and SRE roles</p>
            </div>
          </div>
